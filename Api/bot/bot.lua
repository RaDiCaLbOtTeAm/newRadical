...
bot_token = "538841582:AAFQd5O1v72JjxxGSKI4rCXw3i4qGYyqvls" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		BeyondTeam = '/root/MeGaPlus/Cli'
	elseif not server_user:match("^root$") then
		BeyondTeam = '/home/'..server_user..'/MeGaPlus/Cli'
	end
  ...
  config = {
    ...
    sudo_users = {516488530,517517253,482089569},--Sudo users
    admins = {},
    disabled_channels = {},
